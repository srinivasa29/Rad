...
const Footer = () => (
    <footer className="relative z-10 pt-8 pb-6 border-t border-white/5 bg-transparent">
        <div className="max-w-[95vw] mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-white/60">
