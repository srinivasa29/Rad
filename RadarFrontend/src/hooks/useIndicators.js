...
// --- Manual indicator calculation functions (used by named export useIndicators) ---
...
// Named Export: useIndicators (for TradingChart)
...
// --- Package-based indicator calculation functions (used by default export) ---

const safe = (arr) => Array.isArray(arr) ? arr : [];

// Default Export: useIndicatorsDefault (for ChartPane)
const useIndicatorsDefault = (data, activeIndicators) => {
  return useMemo(() => {
    if (!data || data.length < 30 || !activeIndicators) return {};
...
export default useIndicatorsDefault;
